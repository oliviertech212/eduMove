      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mt-4 flex flex-wrap gap-4">
          ...
          <div className="bg-red-50 px-4 py-2 rounded-md flex items-center">
            ...
            <div className="font-bold">
              {bookings.filter(b => b.status === 'Arrived At School').length}
            </div>
          </div>

          <div className="bg-yellow-50 px-4 py-2 rounded-md flex items-center">
            <FaBell className="text-yellow-500 mr-2" />
            <div className="mr-3">Arrived At Destination:</div>
            <div className="font-bold">
              {bookings.filter(b => b.status === 'Arrived At Destination').length}
            </div>
          </div>
        </div>
      </div>
